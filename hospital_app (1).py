...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#00c8ff 0%,#0066ff 60%,#1500ff 100%);
...
with st.form("triage_form"):
    ...
    <div style="background:#80b3ff;border:1px solid #ffffff;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#ffe4a6;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">1</span>
            <span style="font-size:16px;font-weight:600;color:#ffffff;">What are your main symptoms?</span>
...
if submitted:
    ...
    with prob_col:
        ...
        st.markdown(bars_html + """
            <!-- COLOR7 -->
            <div style="margin-top:20px;background:#ffe4a6;border:1px solid #ffffff;
                        border-radius:10px;padding:12px 14px;font-size:12px;color:#ffffff;">
                <strong>Model:</strong>99.5%<br>
